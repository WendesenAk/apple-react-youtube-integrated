	...
	<div className="footer-wrapper">
		<div className="container"> 
			...
			{FooterData.map((data, i)=>{
				return (
                <div key={i} className="links-wrapper-1 col-sm-12 col-md expanded">
					<FooterLink myData={data.columns} />
				</div>
				)
			})}							
			</div> 
